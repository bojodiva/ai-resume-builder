...
import { useLeadershipExperience } from "@/contexts/LeadershipContext";
...
export default function LeadershipExperiencePage(){
    ...
    const { addLeadershipExperience } = useLeadershipExperience();
  ...
  const handleAdd = () => {
    ...
    return(
       ...
       <Box maxW="700px" mx="auto" mt="100px" mb="100px" p={8} border="1px solid #ccc" borderRadius="md">
        <Box width="dvh">
            <Heading mb={8} fontSize={["22px", "28px", "32px", "36px"]}>Add Leadership Experience</Heading>
